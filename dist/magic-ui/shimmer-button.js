...
var ShimmerButton = react_1.default.forwardRef(function (_a, ref) {
    ...
    return (react_1.default.createElement("button", __assign({ style: {
        ...
        react_1.default.createElement("div", { className: (0, utils_1.cn)('-z-30 blur-[2px]', 'absolute inset-0 overflow-visible [container-type:size]') },
        ...
        children,
        react_1.default.createElement("div", { className: (0, utils_1.cn)('insert-0 absolute size-full', 'rounded-2xl px-4 py-1.5 text-sm font-medium shadow-[inset_0_-8px_10px_#ffffff1f]', 
            // transition
        ...
        react_1.default.createElement("div", { className: (0, utils_1.cn)('absolute -z-20 [background:var(--bg)] [border-radius:var(--radius)] [inset:var(--cut)]') })));
});
