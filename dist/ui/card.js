...
var CardTitle = React.forwardRef(function (_a, ref) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (React.createElement("h3", __assign({ ref: ref, className: (0, utils_1.cn)('font-semibold leading-none tracking-tight', className) }, props)));
});
exports.CardTitle = CardTitle;
CardTitle.displayName = 'CardTitle';
var CardDescription = React.forwardRef(function (_a, ref) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (React.createElement("p", __assign({ ref: ref, className: (0, utils_1.cn)('text-sm text-muted-foreground', className) }, props)));
});
exports.CardDescription = CardDescription;
CardDescription.displayName = 'CardDescription';
var CardContent = React.forwardRef(function (_a, ref) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (React.createElement("div", __assign({ ref: ref, className: (0, utils_1.cn)('p-2', className) }, props)));
});
exports.CardContent = CardContent;
CardContent.displayName = 'CardContent';
var CardFooter = React.forwardRef(function (_a, ref) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (React.createElement("div", __assign({ ref: ref, className: (0, utils_1.cn)('flex items-center p-2 pt-0', className) }, props)));
});
